...
const NOTIFS = [
  ...
  },
  {
    ...
    desc: "Fires when a probation extension is signed. Notifies the LM that the 3-month extension cycle has started (Ext-Mth1-Review).",
    recipient: { name: "Marcus Lee", role: "LM", empId: "LM-001" },
  ...
  {
    id: "N-14", code: "N-14", type: "reminder",
    title: "Early termination — stakeholders notified (F-11)",
    desc: "Fires when early termination is recorded. Cancels all pending tasks and notifies HR, Payroll, and IT access teams.",
    recipient: { name: "Stakeholders", role: "Multi", empId: "MULTI" },
    relatedEmp: { name: "Jamal Idris", empId: "EMP-0655" },
    triggeredBy: "Marcus Lee · LM (F-11 submission)",
    triggeredAt: "10 Apr 2026 · 15:44 MYT",
    deliveredAt:  "10 Apr 2026 · 15:44 MYT",
    channel: "In-app · Payroll API · IT access revocation",
    policy: "F-11 · A-05",
    status: "Delivered",
    retries: 0,
    ackBy: null,
    ip: "10.42.77.3",
    sessionId: "LM-TERM-0655-F11",
    hash: "SHA256-N14JAMAL0655TERM",
  },
  {
