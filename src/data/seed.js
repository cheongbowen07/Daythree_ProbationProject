...
export function seedRecords() {
  const raw = [
    ...
    { id: 12, name: "Leon Tan",      empId: "EMP-0489", grade: "M10", gradeBand: "M09_M12",   wf: "WF1", lm: "David Tan",  joined: "13 Dec 2025", day: 188, status: "Pending-Letter",          phase: "NEW", currentCycle: 6, employmentStatus: "Probation",           email: "leon.tan@faith.my",       phone: "+60 17-556 7890", position: POSITIONS["M10"], slaDays: 4, slaBreached: true, reviews: [{ cycle: 1, rpm: 4 }, { cycle: 2, rpm: 4 }, { cycle: 3, rpm: 3 }, { cycle: 4, rpm: 4 }, { cycle: 5, rpm: 4 }, { cycle: 6, rpm: 4 }], kpis: defaultKpis() },
